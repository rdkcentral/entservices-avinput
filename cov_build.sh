...
############################
# Build entservices-avinput
echo "======================================================================================"
echo "buliding entservices-avinput"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-avinput \
-DUSE_THUNDER_R4=ON \
...
-Wall -Wno-unused-result -Werror -Wno-error=format -Wno-format \
-Wl,-wrap,system -Wl,-wrap,popen -Wl,-wrap,syslog \
-DUSE_THUNDER_R4 -DTHUNDER_VERSION=4 -DTHUNDER_VERSION_MAJOR=4 -DTHUNDER_VERSION_MINOR=4" \

cmake --build build/entservices-avinput --target install
echo "======================================================================================"
exit 0
